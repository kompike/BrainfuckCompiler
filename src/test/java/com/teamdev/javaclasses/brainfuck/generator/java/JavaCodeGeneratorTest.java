...
public class JavaCodeGeneratorTest {
    ...
    public void testPrintCommandGenerator() {
        ...
        assertEquals("Obtain text value does not equals 'System.out.print((char) memory[pointer]);'",
                "\tSystem.out.print((char) memory[pointer]);" + LINE_SEPARATOR, generator.execute(commands));
    }
